...
<html>
    ...
    <body>
        ...
        <h1>Code Commited:: GitLab -> Jenkins -> Maven -> Nexus-->checking pol scm-->on sample_pull</h1>
        <h1>Code Commited:: GitLab -> Jenkins -> Maven -> Nexus-->checking pol scm-->on sample_pull -->checking dependency</h1>
